...
class Aggregator(object):
    ...
    def _mix_neighbor_vectors(self, neighbor_vectors, neighbor_relations, user_embeddings):
        ...
        if not avg:
            ...
            print("user_embeddings after reshape")
            print(user_embeddings)
            ...
            user_relation_scores_normalized = tf.compat.v1.math.softmax(user_relation_scores, dim=-1)
            print("user_relation_score_normalized: ")
            print(user_relation_scores_normalized)

            # [batch_size, -1, n_neighbor, 1]
            user_relation_scores_normalized = tf.expand_dims(user_relation_scores_normalized, axis=-1)
            print("user_relation_score_normalized expand dims: ")
            print(user_relation_scores_normalized)
...
class SumAggregator(Aggregator):
    ...
    def _call(self, self_vectors, neighbor_vectors, neighbor_relations, user_embeddings):
        ...
        output = tf.compat.v1.nn.dropout(output, keep_prob=1-self.dropout)
